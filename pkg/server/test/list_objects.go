...
//				channel := listObjectsQuery.ExecuteStreamed(ctx, &openfgav1.StreamedListObjectsRequest{
//					StoreId:          storeID,
...
//					if result.FinalMetadata != nil {
//						t.Log(result.FinalMetadata)
//						break
//					}
//					if result.Err != nil {
//						require.Fail(t, result.Err.Error(), "unexpected error")
//					}
//					streamedObjectIDs = append(streamedObjectIDs, result.ObjectID)
//				}
//
